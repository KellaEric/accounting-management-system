...
#include <time.h>
#include <stdlib.h>
using namespace std; // A project of bank acccount application programmed by Eric usingC++
class account
{
        int accountnumber;
        char name[50];
...
int main()
{
        ...
        for (;;)
        {
                ...
                case '8':
                        system("color 04");
                        cout << "\n\n\tThanks for using Kella Eri's Bank Management System";
                        break;
                default:
                        cout << "Invalid Option\n";
                }
...
void display_all()
{
        int bankPassword = 222, enteredPassword;
        ...
        if (enteredPassword == bankPassword)
        {
                ...
                cout << "Please enter the correct password for your veriifications.\n";
        }
}
...
void deposit_withdraw(int n, int option)
{
        ...
        while (!File.eof() && found == false)
        {
                ...
                if (ac.get_accountnumber() == n)
                {
                        ...
                        {
                                cout << "\n\n\tTO WITHDRAW AMOUNT ";
                                cout << "\n\nEnter The amount you are comfortable to withdraw: ";
                                cin >> amt;
